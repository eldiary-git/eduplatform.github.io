...
move_uploaded_file($_FILES["matching2"]["tmp_name"],"profilepics/".$matching2);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set matching2='$matching2' where id='$uid' ");
...
?>
		<h2>Update Image 2 </h2>


		<input type="hidden" name="oldpic" value="<?php  echo $row['matching2'];?>">
