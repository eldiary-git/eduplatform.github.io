...
move_uploaded_file($_FILES["questionImage"]["tmp_name"],"profilepics/".$questionImage);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set questionImage='$questionImage' where id='$uid' ");
...
?>
		<h2>Update Question Image</h2>


		<input type="hidden" name="oldpic" value="<?php  echo $row['questionImage'];?>">
