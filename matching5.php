...
move_uploaded_file($_FILES["matching5"]["tmp_name"],"profilepics/".$matching5);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set matching5='$matching5' where id='$uid' ");
...
?>
		<h2>Update Image 5</h2>


		<input type="hidden" name="oldpic" value="<?php  echo $row['matching5'];?>">
