...
move_uploaded_file($_FILES["matching4"]["tmp_name"],"profilepics/".$matching4);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set matching4='$matching4' where id='$uid' ");
...
?>
		<h2>Update Image 4 </h2>


		<input type="hidden" name="oldpic" value="<?php  echo $row['matching4'];?>">
