...
move_uploaded_file($_FILES["matching1"]["tmp_name"],"profilepics/".$matching1);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set matching1='$matching1' where id='$uid' ");
...
<h2>Update Matching 2 Image </h2>
		<input type="hidden" name="oldpic" value="<?php  echo $row['matching1'];?>">
