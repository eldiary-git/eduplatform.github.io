...
move_uploaded_file($_FILES["matching3"]["tmp_name"],"profilepics/".$matching3);
  ...
  // Query for data insertion
     $query=mysqli_query($con, "update tblusers set matching3='$matching3' where id='$uid' ");
...
?>
		<h2>Update Image 3 </h2>

		<input type="hidden" name="oldpic" value="<?php  echo $row['matching3'];?>">
